...
def addDotsToGroups():
    ...
    for i in range(94):
        ...
        newdot=dot1.dot(False, radiusDot, radiusSD, i, start, end,(0,0,255))
    ...
    while immune_count<=5:
        ...
        newdot=dot1.dot(False,radiusDot,radiusSD,i,start,end,colors['green'])
        immune.add(newdot)
        allsprites.add(newdot)
        immune_count+=1
    start=(random.randint(0, screen_width),random.randint(0,screen_height))
    end=(random.randint(0, screen_width),random.randint(0,screen_height))
    original_infected=dot1.dot(False,radiusDot,radiusSD,i,start,end,colors['orange'], 'infected')
...
def main():
    ...
    while running:
        ...
        for e in allsprites:
            ...
            e.move()
        for e in allsprites:
            collisions_Infected = pygame.sprite.spritecollide(e, infected, False, pygame.sprite.collide_circle_ratio(3.0))
            collisions_Sick = pygame.sprite.spritecollide(e, sick, False, pygame.sprite.collide_circle_ratio(3.0))
